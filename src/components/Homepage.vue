<template>
  <div class="min-h-screen bg-background">
    <!-- Hero Section -->
    <section class="bg-gradient-to-br from-accent to-secondary/50 py-16 md:py-24">
      <div class="container mx-auto px-6 text-center">
        <h1 class="text-4xl md:text-6xl mb-6 text-foreground">
        ...
        <Button 
          size="lg" 
          @click="$emit('navigateToOrder')"
          class="px-8 py-3 text-lg shadow-lg hover:shadow-xl transition-shadow"
        >
          Order Now
        </Button>
      </div>
    ...
    <section class="py-16 md:py-24">
      <div class="container mx-auto px-6">
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl mb-4 text-foreground">Our Specialties</h2>
        ...
        <div class="text-center mt-12">
          <Button 
            size="lg" 
            @click="$emit('navigateToOrder')"
            class="px-8 py-3 shadow-lg hover:shadow-xl transition-shadow"
          >
            Place Your Order
          </Button>
        </div>
